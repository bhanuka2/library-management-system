...
ReturnRecordService returnRecordService = ServiceFactory.getInstance().getServiceType(ServiceType.IssueRecord);
    ...
    void btnsaveOnAction(ActionEvent event) throws SQLException {
        ...
        Boolean b = returnRecordService.AddRecord(issueRecord);
    ...
    public void loadTable() throws SQLException {
        List<IssueRecord> allRecords = returnRecordService.getAllRecords();
